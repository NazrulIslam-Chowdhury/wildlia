            ...
            <div className="flex justify-between p-4">
                <div className="flex space-x-4">
                    ...
                    <div>
                        ...
                        <span className="text-xs text-gray-300 font">{user.displayName}</span> <br />
                        <span className="text-xs text-gray-300 font">{email}</span>
                    </div>
                </div>
                <div className="flex items-center space-x-2 text-yellow-500">
                    ...
                    <span className="text-xl font-bold font">4.5</span>
                </div>
            </div>
            <div className="p-4 space-y-2 flex-wrap text-sm text-gray-300 font overflow-auto">
                <p className='font'>{comment}</p>
            </div>
            <div className='flex justify-between mt-5'>
                <Link className='no-underline' to={`/modal/:${_id}`}>
                    <button className='bg-green-200 hover:bg-green-400 py-2 px-4 font text-black text-lg font-bold rounded'>Edit review</button>
                </Link>
