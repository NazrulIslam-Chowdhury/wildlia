                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1">
                            <li>
                                <Link className='no-underline text-black' to="">Features</Link>
                            </li>
                            <li>
                                <Link className='text-black no-underline' to="">Integrations</Link>
                            </li>
                            <li>
                                <Link className='text-black no-underline' to="">Pricing</Link>
                            </li>
                            <li>
                                <Link className='text-black no-underline' to="">FAQ</Link>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1">
                            <li>
                                <Link className='text-black no-underline' to="">Privacy</Link>
                            </li>
                            <li>
                                <Link className='text-black no-underline' to="">Terms of Service</Link>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3">
                        ...
                        <ul className="space-y-1">
                            <li>
                                <Link className='text-black no-underline' to="">Public API</Link>
                            </li>
                            <li>
                                <Link className='text-black no-underline' to="">Documentation</Link>
                            </li>
                            <li>
                                <Link className='text-black no-underline' to="">Guides</Link>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3">
